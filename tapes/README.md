...
```sh
vhs tapes/signs.tape
vhs tapes/report.tape
vhs tapes/heatmap.tape
vhs tapes/branch.tape   # produces a PNG screenshot
```

Output files are written to `tapes/output/` (not committed).
