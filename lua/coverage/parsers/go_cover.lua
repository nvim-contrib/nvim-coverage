...
--- Parses a coverprofile formatted file into files.
--- @param path Path
...
--- Parses a Go coverprofile file into a CoverageData table.
--- @param path Path
--- @return CoverageData
M.parse = function(path)
    return util.report_to_table(path, parse_coverprofile)
end
